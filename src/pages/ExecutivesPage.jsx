const EXECUTIVES = [
  ...
  { id:5,  name:'Alh. Mujeeb Adebimpe',                  position:'Director of Media / Spokesperson',         photo:'https://drive.google.com/thumbnail?id=17lvCXkkOBY3Bx8b7czZT8wOrEtDWBcIF&sz=w400',  initials:'AM', rank:5  },
  ...
  { id:7,  name:'Olagunju Yussuf Olalekan',              position:'Director of Security and Protocol',        photo:'https://drive.google.com/thumbnail?id=1gu8QFcx9qVbEeDEB_-zyxt_aI2HLw0RN&sz=w400',  initials:'OY', rank:7  },
  { id:8,  name:'Araromi Olaoluwa Shadrack',             position:'Director of Faith & Community Engagement', photo:'https://drive.google.com/thumbnail?id=1N-9f4Ug4NxhzM43L5wzAWg6V1tQivoDY&sz=w400',  initials:'AO', rank:8  },
  { id:9,  name:'Adeolu Timothy Olanrewaju (Larry-Jay)', position:'Director of Students and Mobilization',   photo:'https://drive.google.com/thumbnail?id=1ytguHA9uHCAwjuI5vS3MlrHGeVis6nCh&sz=w400',  initials:'AT', rank:9  },
  ...
  { id:15, name:'Hon. Kareem Taofeek Olanrewaju',        position:'Trustee',                                  photo:'https://drive.google.com/thumbnail?id=110EIzPn8FZR-tz9mJ9aNS4-LPHf252wS&sz=w400',  initials:'KT', rank:15 },
  { id:16, name:'Rasheed Ayotunde Jimoh',                position:'Head of Strategic Communication',          photo:'https://drive.google.com/thumbnail?id=123MIqHqoiV_CUFLNNv8sSP1tXL9Ddiyg&sz=w400',  initials:'RA', rank:16 },
  { id:17, name:'Hon. Olabode Oluwatobi Divine',         position:'Director Special Duties (Osun State)',     photo:'https://drive.google.com/thumbnail?id=1OAnYznSfBrJr1GF6-cPZ9H8ZY3lh2Th5&sz=w400',  initials:'OO', rank:17 },
  { id:18, name:'Adisa Ismail Adesola',                  position:'Director of Youth Mobilization',           photo:'https://drive.google.com/thumbnail?id=1W6XFkISWDCB9PZBq-tol_gg2Ur47rgE6&sz=w400',  initials:'AI', rank:18 },
]

// RTIFN Logo SVG inline
const RTIFNLogo = ({ size = 48 }) => (
  <img src="/logo.jpeg" alt="RTIFN"
...
function ExecCard({ exec, large = false }) {
  ...
  return (
    <div style={{
      ...
      {/* Card body — green gradient background */}
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            fontSize: 40, fontWeight: 900, color: 'rgba(255,255,255,0.5)',
            fontFamily: 'serif',
          }}>
            {exec.initials}
          </div>
